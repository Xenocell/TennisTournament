            ...
            //ENTRIEST PAGE
              ...
              if (ctx.req.method == "POST"){
                ...
                //REPORT   
                  ...
                  let last_list = []
                  const points = (Number(status_tournament.low_points) == 0) ? [64, 62, 60, 58, 56, 54, 52, 50] : [60, 58, 56, 54, 52, 50, 48, 46]
                  ...
                  for(let sub_tournament of sub_tournamnets){
                    ...
                    for(let i = 0; i < winners_sub_tournament.length; i++){
                      if(winners_sub_tournament[i].name != 'null')
                        push_player( {name: winners_sub_tournament[i].name, rni: lniToId(winners_sub_tournament[i].rni), points: points[i], place: i+1} )
                      else
                        count_null++
                    }
              ...
              if (ctx.req.method == "POST"){
                ...
                const data = {
                  ...
                  low_points: ctx.req.body.low_points,
                }
                console.log(data)
